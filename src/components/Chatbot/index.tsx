...
export const Chatbot = () => {
  ...
  if (isRespostaCorreta) {
    return (
      ...
      <div className="fixed bottom-3 right-3 bg-[#e3e2e2]  w-[80%] h-[500px] lg:h-[700px] sm:w-[60%] md:w-[50%] lg:w-[45%] xl:w-[35%]  2xl:w-[30%] rounded-xl flex flex-col shadow-2xl border-2 ">
        ...
        <div className="fixed bottom-3 right-3 cursor-pointer ">
          <SpeedDial>
            <SpeedDialHandler onClick={handleButtonClick}>
              <FontAwesomeIcon
                icon={faCommentDots}
                className="text-5xl text-[#0062ff] shadow-2xl "
